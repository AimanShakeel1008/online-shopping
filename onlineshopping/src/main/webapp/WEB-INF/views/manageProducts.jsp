				...
				<div class="panel-body">
					...
					>
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<sf:input type="text" path="unit_price" id="unitPrice" placeholder="Unit Price in &#8377" class="form-control"></sf:input>
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<sf:input type="number" path="quantity" id="quantity" placeholder="Quantity Available" class="form-control"></sf:input>
							</div>
						</div>
